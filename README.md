...
| F-02 | Fitur pemberian informasi rekomendasi restoran ataupun tempat belanja kepada pengguna.                     |
| F-03 | Fitur pencarian restoran ataupun tempat belanja yang diinginkan dengan search bar ataupun sort filter.    |
| F-04 | Fitur untuk pemilihan makanan yang diinginkan pada restoran atau tempat belanja.                           |
| F-05 | Fitur untuk melakukan pemesanan terhadap makanan yang diinginkan.                                          |
| F-06 | Fitur untuk melakukan pengecekan terhadap status informasi keberadaan dari pengiriman makanan.            |
| F-07 | Fitur untuk melakukan pemberian penilaian rating dan komentar setelah melakukan pemesanan.                 |
| F-08 | Fitur untuk melakukan pengecekan terhadap rating dan komentar dari berbagai restoran, tempat belanja, ataupun makanan yang dijual. |
| F-09 | Fitur untuk melakukan pengecekan terhadap riwayat daftar pembelian yang telah dilakukan sebelumnya.        |
| F-10 | Fitur untuk menandai dan mengecek berbagai restoran, tempat belanja, ataupun makanan yang sering dibeli sebagai favorit. |
